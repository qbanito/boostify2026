...
import {
  ...
  Plug, Zap, ArrowRight, Star, Play, Target, Wand2
} from "lucide-react";
...
const GOALS: Goal[] = [
  {
    ...
    description: "Generate AI-powered posts, carousels, reels & stories",
    icon: ImagePlus,
    color: "from-violet-500 to-purple-600",
    tab: "create",
    features: ["AI Image Generation", "Carousel Creator", "Reel Concepts", "Story Templates"],
  },
  {
    id: "grow",
    title: "Grow Followers",
    description: "Extract leads, find influencers & plan growth strategies",
    icon: TrendingUp,
    color: "from-emerald-500 to-green-600",
    tab: "growth",
    features: ["Profile Extraction", "Hashtag Research", "Engagement Plans", "Audience Targeting"],
  },
  {
    id: "optimize",
    title: "Optimize Profile",
    description: "AI captions, hashtags, bio optimization & best posting times",
    icon: Brain,
    color: "from-blue-500 to-cyan-600",
    tab: "tools",
    features: ["Caption Generator", "Hashtag Engine", "Bio Optimizer", "Timing Analyzer"],
  },
  {
    id: "analyze",
    title: "Analyze Performance",
    description: "Full audits, growth forecasts & competitor analysis",
    icon: BarChart2,
    color: "from-amber-500 to-orange-600",
    tab: "analytics",
    features: ["Account Audit", "Growth Forecast", "Competitor Intel", "Weekly Reports"],
  },
];
    ...
    <AnimatePresence>
      {open && (
        ...
        >
          ...
          >
            {/* Header Gradient */}
            <div className="relative h-28 bg-gradient-to-br from-[#833ab4] via-[#fd1d1d] to-[#fcb045] overflow-hidden">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                ...
                >
                  ...
                  <span className="text-white/80 text-xs font-medium">Let's set up your growth engine</span>
                </motion.div>
              </div>
                ...
                {STEPS.map((s, i) => (
                  <div key={s.id} className="flex items-center gap-1.5 flex-1">
                    <motion.div
                      animate={{
                        scale: step === i ? 1.15 : 1,
                        backgroundColor: step > i ? "#22c55e" : step === i ? "#833ab4" : "transparent",
                      }}
            ...
            {/* Content Area */}
            <div className="px-6 py-4 min-h-[320px] relative overflow-hidden">
              <AnimatePresence mode="wait" custom={direction}>
                  ...
                  >
                    <div className="text-center space-y-1">
                      ...
                      <p className="text-xs text-muted-foreground">
                        Select which artist profile you want to grow on Instagram
                      </p>
                    </div>
                          ...
                          >
                            ...
                            <div className="relative">
                              {artist.profileImage ? (
                                ...
                                <div className="w-12 h-12 rounded-full bg-gradient-to-br from-[#833ab4] to-[#fd1d1d] flex items-center justify-center ring-2 ring-background">
                              ...
                              {chosenArtist?.id === artist.id && (
                                <motion.div
                                  initial={{ scale: 0 }}
                                  animate={{ scale: 1 }}
                                  className="absolute -bottom-0.5 -right-0.5 w-5 h-5 bg-[#833ab4] rounded-full flex items-center justify-center"
                                >
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              <div className="flex items-center gap-2 mt-0.5">
                                ...
                                {artist.instagramHandle && (
                                  <span className="text-[10px] text-[#833ab4] font-medium">@{artist.instagramHandle}</span>
                                )}
                              </div>
                            </div>
                            ...
                            <ChevronRight className={`w-4 h-4 transition-colors ${
                              chosenArtist?.id === artist.id ? "text-[#833ab4]" : "text-muted-foreground/30"
                            }`} />
                          </motion.button>
                        ))
                      )}
                ...
                {step === 2 && (
                  ...
                  >
                    <div className="text-center space-y-1">
                      <h2 className="text-lg font-bold">Your Growth Toolkit</h2>
                      <p className="text-xs text-muted-foreground">
                    ...
                    {/* Artist Card */}
                    <div className="flex items-center gap-3 p-3 rounded-xl bg-gradient-to-r from-[#833ab4]/5 via-[#fd1d1d]/5 to-[#fcb045]/5 border border-[#833ab4]/20">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          {chosenArtist?.instagramHandle && (
                            <span className="text-[10px] text-[#833ab4]">@{chosenArtist.instagramHandle}</span>
                          )}
                        </div>
                      </div>
                      <Badge className={`bg-gradient-to-r ${chosenGoal?.color || "from-[#833ab4] to-[#fd1d1d]"} text-white text-[10px] border-0`}>
                        {chosenGoal?.title}
                      </Badge>
                    </div>
                    ...
                    <div className="space-y-2">
                      {[
                        { icon: Plug, label: "Chrome Extension", desc: ig.isConnected ? "Connected — syncing data" : "Connect to sync Instagram data", done: ig.isConnected, color: "text-green-500" },
                        { icon: Brain, label: "AI Content Engine", desc: "Captions, hashtags, bio & ideas generator", done: true, color: "text-blue-500" },
                        { icon: ImagePlus, label: "Visual Creator", desc: "AI image generation, carousels & reels", done: true, color: "text-violet-500" },
                        { icon: TrendingUp, label: "Growth Planner", desc: "Strategies, audience targeting & extraction", done: true, color: "text-emerald-500" },
                        { icon: BarChart2, label: "Analytics", desc: "Account audits, forecasts & reports", done: true, color: "text-amber-500" },
                      ].map((tool, i) => (
                        <motion.div
                          key={tool.label}
                          initial={{ opacity: 0, x: -20 }}
                ...
                {step === 3 && (
                  ...
                  >
                    ...
                    <motion.div
                      ...
                      className="relative"
                    >
                      <div className="w-24 h-24 rounded-3xl bg-gradient-to-br from-[#833ab4] via-[#fd1d1d] to-[#fcb045] flex items-center justify-center shadow-2xl shadow-[#fd1d1d]/30">
                      ...
                      {[...Array(6)].map((_, i) => (
                        ...
                        >
                          <Star className="w-3 h-3 text-[#fcb045] fill-[#fcb045]" />
                        </motion.div>
                      ))}
                    </motion.div>
                    ...
                    <div className="space-y-2">
                      ...
                      >
                        ...
                        Instagram growth engine is ready. Let's{" "}
                        <span className="font-semibold bg-gradient-to-r from-[#833ab4] to-[#fd1d1d] bg-clip-text text-transparent">
                    ...
                    >
                      {[
                        ...
                        { label: "Actions", value: "20+", icon: Zap },
                        ...
                        <div key={stat.label} className="p-2.5 rounded-xl bg-muted/50 border border-border/50 text-center">
                          <stat.icon className="w-4 h-4 mx-auto text-[#833ab4] mb-1" />
                    ...
                    >
                      <Button
                        ...
                        className="w-full h-12 bg-gradient-to-r from-[#833ab4] via-[#fd1d1d] to-[#fcb045] text-white font-bold text-base rounded-2xl shadow-xl shadow-[#fd1d1d]/30 hover:opacity-90 hover:scale-[1.02] transition-all"
                      >
            ...
            {step < 3 && (
              <div className="px-6 py-4 border-t border-border/50 flex items-center justify-between">
                  ...
                  {STEPS.map((_, i) => (
                    <div
                      ...
                      className={`h-1.5 rounded-full transition-all ${
                        i === step ? "w-6 bg-[#833ab4]" : i < step ? "w-1.5 bg-green-500" : "w-1.5 bg-muted-foreground/20"
                      }`}
                    />
                  ))}
                </div>
                ...
                <Button
                  ...
                  disabled={!canProceed()}
                  onClick={nextStep}
                  className="text-xs gap-1 bg-gradient-to-r from-[#833ab4] to-[#fd1d1d] text-white rounded-xl disabled:opacity-30"
                >
