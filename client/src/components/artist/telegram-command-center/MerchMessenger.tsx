 ...
 * confirm orders and share tracking, all over Telegram.
 */
export function MerchMessenger({ center }: { center: TelegramCenter }) {
  const template =
    ...
    <div className="space-y-5">
      ...
      <GlassCard className="p-4">
        <div className="mb-3 flex items-center gap-2 text-sm text-white/70">
          <Package className="h-4 w-4 text-sky-300" /> Ficha de producto (incluye una imagen para mayor conversión)
        </div>
