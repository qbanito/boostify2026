...
const secrets = {
  ...
  resend: {
    ...
    ARTISTS_8: process.env.RESEND_API_ARTISTS_8 || '',
    ARTISTS_9: process.env.RESEND_API_ARTISTS_9 || '',
    ARTISTS_10: process.env.RESEND_API_ARTISTS_10 || '',
    ARTISTS_11: process.env.RESEND_API_ARTISTS_11 || '',
  },
